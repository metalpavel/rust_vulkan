...
pub unsafe fn create_command_buffers(device: &Device, data: &mut app_data::Data, vertices_count: u32) -> Result<()> {
    // Allocate
    ...
    for (i, command_buffer) in data.command_buffers.iter().enumerate() {
        ...
        device.cmd_draw(*command_buffer, vertices_count, 1, 0, 0);
